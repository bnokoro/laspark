                                            ...
                                            <div class="inbox-wid">
                                                <a href="#" class="text-dark">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img float-left mr-3"><img src="http://lexa-v.laravel.themesbrand.com/admin/images/user-1.jpg" class="thumb-md rounded-circle" alt=""></div>
                                                ...
                                                <a href="#" class="text-dark">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img float-left mr-3"><img src="http://lexa-v.laravel.themesbrand.com/admin/images/user-2.jpg" class="thumb-md rounded-circle" alt=""></div>
                                                ...
                                                <a href="#" class="text-dark">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img float-left mr-3"><img src="http://lexa-v.laravel.themesbrand.com/admin/images/user-3.jpg" class="thumb-md rounded-circle" alt=""></div>
                                                ...
                                                <a href="#" class="text-dark">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img float-left mr-3"><img src="http://lexa-v.laravel.themesbrand.com/admin/images/user-4.jpg" class="thumb-md rounded-circle" alt=""></div>
                                                ...
                                                <a href="#" class="text-dark">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img float-left mr-3"><img src="http://lexa-v.laravel.themesbrand.com/admin/images/user-5.jpg" class="thumb-md rounded-circle" alt=""></div>
                                                ...
                                                <a href="#" class="text-dark">
                                                    <div class="inbox-item">
                                                        <div class="inbox-item-img float-left mr-3"><img src="http://lexa-v.laravel.themesbrand.com/admin/images/user-6.jpg" class="thumb-md rounded-circle" alt=""></div>
                                    ...
                                    <div class="card widget-user m-b-20">
                                        ...
                                        <div class="p-4">
                                            <div class="float-left mt-2 mr-3">
                                                <img src="http://lexa-v.laravel.themesbrand.com/admin/images/user-2.jpg" alt="" class="rounded-circle thumb-md">
                                            </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-vertical">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="http://lexa-v.laravel.themesbrand.com/admin/images/user-2.jpg" alt="user-image" class="thumb-sm rounded-circle mr-2"/>
                                                            Herbert C. Patton
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="http://lexa-v.laravel.themesbrand.com/admin/images/user-3.jpg" alt="user-image" class="thumb-sm rounded-circle mr-2"/>
                                                            Mathias N. Klausen
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="http://lexa-v.laravel.themesbrand.com/admin/images/user-4.jpg" alt="user-image" class="thumb-sm rounded-circle mr-2"/>
                                                            Nikolaj S. Henriksen
                                                        </td>
                                                        <td><i class="mdi mdi-checkbox-blank-circle text-success"></i> Confirm</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="http://lexa-v.laravel.themesbrand.com/admin/images/user-5.jpg" alt="user-image" class="thumb-sm rounded-circle mr-2"/>
                                                            Lasse C. Overgaard
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="http://lexa-v.laravel.themesbrand.com/admin/images/user-6.jpg" alt="user-image" class="thumb-sm rounded-circle mr-2"/>
                                                            Kasper S. Jessen
                                                        </td>
                                                        <td><i class="mdi mdi-checkbox-blank-circle text-success"></i> Confirm</td>
                                                        <td>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-vertical mb-1">
                                                    ...
                                                    <tr>
                                                        <td>#12354781</td>
                                                        <td>
                                                            <img src="http://lexa-v.laravel.themesbrand.com/admin/images/user-1.jpg" alt="user-image" class="thumb-sm mr-2 rounded-circle"/>
                                                    ...
                                                    <tr>
                                                        <td>#52140300</td>
                                                        <td>
                                                            <img src="http://lexa-v.laravel.themesbrand.com/admin/images/user-2.jpg" alt="user-image" class="thumb-sm mr-2 rounded-circle"/>
                                                    ...
                                                    <tr>
                                                        <td>#96254137</td>
                                                        <td>
                                                            <img src="http://lexa-v.laravel.themesbrand.com/admin/images/user-3.jpg" alt="user-image" class="thumb-sm mr-2 rounded-circle"/>
                                                    ...
                                                    <tr>
                                                        <td>#12365474</td>
                                                        <td>
                                                            <img src="http://lexa-v.laravel.themesbrand.com/admin/images/user-4.jpg" alt="user-image" class="thumb-sm mr-2 rounded-circle"/>
                                                    ...
                                                    <tr>
                                                        <td>#85214796</td>
                                                        <td>
                                                            <img src="http://lexa-v.laravel.themesbrand.com/admin/images/user-5.jpg" alt="user-image" class="thumb-sm mr-2 rounded-circle"/>
                                                            BeoPlay Speaker
                                                        </td>
                                                        <td><span class="badge badge-pill badge-success">Delivered</span></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>#12354781</td>
                                                        <td>
                                                            <img src="http://lexa-v.laravel.themesbrand.com/admin/images/user-6.jpg" alt="user-image" class="thumb-sm mr-2 rounded-circle"/>
                                                            Riverston Glass Chair
                                                        </td>
                                                        <td><span class="badge badge-pill badge-success">Delivered</span></td>
                                                        <td>
